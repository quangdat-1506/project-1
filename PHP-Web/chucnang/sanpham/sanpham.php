...
<div id="banner-t" class="text-center">
    ...
    <div class="row">
        <div class="banner-t-item col-md-6 col-sm-12 col-xs-12">
            <a href="index.php?page_layout=danhsachsp&id_dm=5"><img src="img/home/banner1.jpg" alt="" class="img-thumbnail"></a>
        </div>
        <div class="banner-t-item col-md-6 col-sm-12 col-xs-12">
            <a href="index.php?page_layout=danhsachsp&id_dm=6"><img src="img/home/banner2.jpg" alt="" class="img-thumbnail"></a>
        </div>
    </div>
</div>
<div id="wrap-inner" style="margin-bottom: 40px;">
    <div class="products">
        <h3 style="color: #161617;">sản phẩm bán chạy</h3>
    ...
    ?>
    <div class="products">
        <h3 style="color: #161617;">sản phẩm mới</h3>
        <div class="product-list row">
            <?php
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
        ...
        <div class="item">
            <img src="img/home/slide-4.jpg" alt="New York">
            <div class="carousel-caption">
